	...
	var
		...
		mod = function()
		{
			...
			this.decorate_radio = function(el)
			{
				...
				wrapper.bind('click.deco', context, callback_radio);
				wrapper.bind('change.deco', context, callback_radio_change);
				el.bind('change.deco', context, callback_radio_change);
				el.bind('click.deco', context, callback_radio_change);
			...
			var callback_radio = function(e)
			{
				...
				pwf.jquery('input[name=' + e.data.box.attr('name') + ']').trigger('change');
			...
			var callback_option = function(e)
			{
				...
				e.data.opt.prop('selected', true).click().trigger('change');
				e.data.deco.hide_menu(e.data.el, e.data.clickable);
			};
